...
pg_encname pg_encname_tbl[] =
	{
		...
		{
			"euccn", PG_EUC_CN}, /* EUC-CN; Extended Unix Code for simplified
								 * Chinese */
		{
			"eucjis2004", PG_EUC_JIS_2004}, /* EUC-JIS-2004; Extended UNIX Code fixed
								 * Width for Japanese, standard JIS X 0213 */
		{
			"eucjp", PG_EUC_JP}, /* EUC-JP; Extended UNIX Code fixed Width for
								 * Japanese, standard OSF */
		{
			"euckr", PG_EUC_KR}, /* EUC-KR; Extended Unix Code for Korean , KS
								 * X 1001 standard */
		{
			"euctw", PG_EUC_TW}, /* EUC-TW; Extended Unix Code for
								 *
								 * traditional Chinese */
		{
			"gb18030", PG_GB18030}, /* GB18030;GB18030 */
		{
			"gbk", PG_GBK}, /* GBK; Chinese Windows CodePage 936
								 * simplified Chinese */
		{
		...
		{
			"johab", PG_JOHAB}, /* JOHAB; Extended Unix Code for simplified
								 * Chinese */
		{
			"koi8", PG_KOI8R}, /* _dirty_ alias for KOI8-R (backward
								 * compatibility) */
		{
		...
		{
			"win", PG_WIN1251}, /* _dirty_ alias for windows-1251 (backward
								 * compatibility) */
		{
