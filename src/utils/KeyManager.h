...
public:
    ...
    typedef uint8_t masterKey_t[MasterKeySize];
...
#else
    string _masterKeyPath = "/etc/encryptsql/masterKey.plain";
    string _deriviedKeyPath = "/etc/encryptsql/deriviedKey.plain";
#endif
    mutable int _status = NEW;
