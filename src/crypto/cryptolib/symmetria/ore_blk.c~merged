...
int ore_blk_compare(int *result_p, ore_blk_ciphertext ctxt1, ore_blk_ciphertext ctxt2)
{
  ...
  for (int i = 0; i < nblocks; i++)
  {
    byte *a = ctxt1->comp_left + offset_left;
    byte *b = ctxt2->comp_left + offset_left;
    int c = memcmp(ctxt1->comp_left + offset_left, ctxt2->comp_left + offset_left, AES_BLOCK_LEN);
