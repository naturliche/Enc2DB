...
int ctext_parse(string res, ore_blk_ciphertext cipher)
{
    ...
    // mymemcpy(cipher->comp_left, (byte *)nc1, hexsz1);
    ...
    // mymemcpy(cipher->comp_right, (byte *)nc2, hexsz2);
...
//     //(ctxt1, cipher)：" << res3 << endl;

//     int res4;
//     ore_blk_compare(&res4, ctxt2, cipher);
//     //(ctxt2, cipher)：" << res4 << endl;

//     int res5;
//     ore_blk_compare(&res5, ctxt2, ctxt1);
//     //(ctxt2, ctxt1)：" << res5 << endl;
